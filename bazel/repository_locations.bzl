...
DEPENDENCY_REPOSITORIES = dict(
    ...
    proxy_wasm_cpp_sdk = dict(
        ...
        urls = ["https://github.com/proxy-wasm/proxy-wasm-cpp-sdk/archive/558d45a2f496e3039e50584cf8304ae535ca73de.tar.gz"],
        use_category = ["dataplane"],
        cpe = "N/A",
    ),
    proxy_wasm_cpp_host = dict(
        ...
        urls = ["https://github.com/proxy-wasm/proxy-wasm-cpp-host/archive/51e2013584cc87e0a797444b32bca0522252178d.tar.gz"],
        use_category = ["dataplane"],
        cpe = "N/A",
    ),
